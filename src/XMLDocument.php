 ...
 *
 * @see awl / davical https://gitlab.com/davical-project/awl
...
class XMLDocument
{
    ...
    function AddNamespace($namespace, $prefix = null)
    {
        if (!isset($this->namespaces[$namespace])) {
            if (isset($prefix) && ($prefix == "" || isset($this->prefixes[$prefix]))) {
                $prefix = null;
            }
            if ($prefix == null) {
                ...
                if ($prefix == "" || isset($this->prefixes[$prefix])) {
    ...
    {
        if (!isset($this->namespaces[self::$ns_dav])) {
            $this->AddNamespace(self::$ns_dav, '');
        }
    ...
    {
        if (!isset($this->namespaces[self::$ns_caldav])) {
            $this->AddNamespace(self::$ns_caldav, 'C');
        }
    ...
    {
        if (!isset($this->namespaces[self::$ns_carddav])) {
            $this->AddNamespace(self::$ns_carddav, 'VC');
        }
    ...
    {
        if (!isset($this->namespaces[self::$ns_calendarserver])) {
            $this->AddNamespace(self::$ns_calendarserver, 'A');
        }
    ...
    function NewXMLElement($in_tag, $content = false, $attributes = false, $xmlns = null)
    {
        ...
        if (isset($xmlns) && !isset($this->namespaces[$xmlns])) {
