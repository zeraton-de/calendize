...
/**
 * A class for accessing CalDAV servers
 *
...
class CalDAVClient
{
     ...
     */
    public function setMatch($match, $etag = '*'): void
    {
     ...
     */
    public function setDepth(int $depth = 0): void
    {
     ...
     */
    public function setCalendar($url): void
    {
...
//        echo "\nTags array............................................................\n";  print_r( $this->xmltags );
    ...
    function DoRequest( $url = null ) {
        ...
        $fip = fsockopen( $this->protocol . '://' . $this->server, $this->port, $errno, $errstr, self::FSOCK_TIMEOUT); //error handling?
